// benches/iter_intervals_exactly.rs
...
fn bench_iter_intervals_exactly(c: &mut Criterion) {
    let mut group = c.benchmark_group("iter_intervals_exactly");
...
criterion_group! {
    ...
    targets = bench_iter_intervals_exactly
}
