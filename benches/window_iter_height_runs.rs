...
use window_support::{checksum_stack_window_runs, domain_from_bounds, window_count, window_lens};

fn bench_window_iter_height_runs(c: &mut Criterion) {
    let mut group = c.benchmark_group("window_iter_height_runs");
...
criterion_group! {
    ...
    targets = bench_window_iter_height_runs
}
